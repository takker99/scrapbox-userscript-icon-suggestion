...
import {
  ...
  calcPopupMenuStyle,
  calcTriangleStyle,
} from "../lib/calc-style.ts";
import { CursorPosition } from "../types.ts";
import { PopupMenuButton } from "./PopupMenu/Button.tsx";
...
export function PopupMenu({
  ...
  const handleKeydown = useCallback(
    (e: KeyboardEvent) => {
      ...
      const isShiftTab = e.key === "Tab" && !e.ctrlKey && e.shiftKey &&
        !e.altKey;
      const isEnter = e.key === "Enter" && !e.ctrlKey && !e.shiftKey &&
        !e.altKey;
      const isEscape = e.key === "Escape" && !e.ctrlKey && !e.shiftKey &&
        !e.altKey;
